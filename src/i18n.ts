export const translations = {
  en: {
    ...
    navBooking: 'Book a Lesson',
    navAbout: 'About',

    heroTitle: 'Learn Saxophone. Understand Music. Play With Confidence.',
    heroText:
      'Personalized saxophone and music theory tutoring for adults and small groups of all levels.',
    heroButton: 'Explore Lessons',
    bookingButton: 'Request a Lesson',

    lessonsTitle: 'Lessons',
    lessonsText:
      'Choose a lesson based on your musical goals and current experience.',
